...
<%-- Recompilación forzada por actualización --%>
...
<%-- 1. VALIDACIÓN DE SESIÓN (Adaptado para Analista) --%> 
...
<%-- consulta para obtener doc_extenso --%>
<%
    String proyectoId = request.getParameter("id");
    try {
        if (proyectoId != null && !proyectoId.trim().isEmpty() && conn != null) {
            String sqlDoc = "SELECT doc_extenso FROM Proyectos WHERE id_proyecto = ?";
            try (PreparedStatement stmt = conn.prepareStatement(sqlDoc)) {
                stmt.setInt(1, Integer.parseInt(proyectoId));
                try (ResultSet rs = stmt.executeQuery()) {
                    if (rs.next()) {
                        String docExtenso = rs.getString("doc_extenso");
                    }
                }
            }
        }
...
<% 
    ...
    List<Map<String, Object>> grupoTrabajo = new ArrayList<>();
    ...
    if (proyectoId == null || proyectoId.trim().isEmpty()) {
        ...
        try {
            ...
            if (mensajeError == null) {
                ...
                // --- 7. USUARIO (Comprobante vigencia) ---
...
<head>
  ...
  <title>COVEICYDET - Detalle del Proyecto (Vista Analista)</title>
  ...
  <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-6 card p-6 border-l-4 border-red-500">
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <div class="mt-4">
              <a href="/proyectos/pages/analista/proyectos/" class="text-sm font-medium text-red-600 hover:text-red-500">
      ...
      <div class="project-header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div class="flex gap-3">
            ...
            <a href="/proyectos/pages/analista/infoProyecto/formatoImpresion.jsp?id=<%= proyecto.get("id") %>" target="_blank"
               class="btn-secondary">
              <i class="fas fa-print"></i>
              <span class="hidden md:inline">Imprimir Resumen</span>
            </a>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="space-y-8">
        ...
        <!-- Botón de volver -->
        <div class="card p-6">
          <a href="/proyectos/pages/analista/proyectos/" class="btn-outline w-full">
            <i class="fas fa-arrow-left"></i>
            Volver al Listado de Proyectos
          </a>
        </div>
