...
<%
    // Verificar si viene de una activación exitosa
    ...
    // Si no viene de una activación, redirigir al inicio
...
<head>
    ...
    <title>Cuenta Activada - COVEICYDET</title>
...
<body class="flex items-center justify-center p-4">
    <div class="success-card bg-white rounded-2xl shadow-2xl p-8 md:p-12 max-w-lg w-full text-center">
        ...
        <p class="text-gray-600 mb-8 leading-relaxed">
            Su cuenta ha sido registrada en el 
    ...
    <script>
        ...
        if (window.history.replaceState) {
            window.history.replaceState(null, null, '/proyectos/registroexitoso/');
        }
    </script>
</body>
</html>
